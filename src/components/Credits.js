...
const Credits = () => (
  ...
  <div className="credits-section flex-l items-start content-start justify-between mt5">
    ...
    <div className="w-100 w-70-l pa5-l">
      ...
      <p className="lh-copy black f3 mb4"><span className="label">Producers</span><br/>Jacob Z. Gross<br/>
      Erik Sutch</p>
      

      <p className="lh-copy black f3 mb4"><span className="label">Director of Photography</span><br /><a target="_blank" href="http://www.daniellecalodney.com/">Danielle Calodney</a></p>

      <p className="lh-copy black f3 mb4"><span className="label">Composer</span><br /><a target="_blank" href="https://vimeo.com/mattfletchernoisycreativ">Matt Fletcher</a></p>

      <p className="lh-copy black f3 mb4"><span className="label">Additional Music</span><br />Julius Eastman “Femenine”<br />
      Shin Joong Hyun “I Don’t Like”<br />
